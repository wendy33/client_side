...
public class SessionActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.subCatIDs = this.intArrayToIntegerList(extras
				.getIntArray("subCatIDs"));
		this.subCatNames = this.stringArrayToStringList(extras
				.getStringArray("subCatNames"));
	...
	private SessionCategoryWidget createWidget(int subCatID, String subCatName) {
		...
		SessionCategoryWidget widget = (SessionCategoryWidget) inflater
				.inflate(R.layout.session_category_widget, null);
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				for (int index = 0; index < subCatIDs.size(); ++index) {
					...
					SessionCategoryWidget widget = subCatIDToWidget
							.get(subCatID);
	...
	public String getRecordMessage() {
		...
		if (!incomplete.isEmpty()) {
			...
			message = helperMessage(message, incomplete);
//			message = "<b>If you submit now the following categories will be tagged as aborted:</b> <br>";
//			for (int subCatID : incomplete) {
//				String subCatName = this.subCatNames.get(this.subCatIDs
//						.indexOf(subCatID));
...
//			message += "<br>";
		...
		if (!notStarted.isEmpty()) {
			...
			message = helperMessage(message, notStarted);
//			message += "<b>If you submit now the following categories will be deleted</b>: <br>";
...
//			message += "<br>";
	...
	public String helperMessage(String message, List<Integer> intList) {
		for (int subCatID : intList) {
			String subCatName = this.subCatNames.get(this.subCatIDs
					.indexOf(subCatID));
			message += subCatName + " <br>";
		}
	...
	public void recordWidget(int subCatID) {
		...
		tether.addEntry(this, this.dogID, subCatID, userID, plan, sessionDate,
				trialsResult, false);
	}
	...
	public void addNewWidgetAfterEdit() {
		SessionCategoryWidget widget = this.createWidget(
				this.subCatIDBeingEdited, this.subCatNameBeingEdited);
		this.subCatIDToWidget.put(this.subCatIDBeingEdited, widget);
		this.subCatIDs.add(this.indexOfSubCatIDBeingEdited,
				this.subCatIDBeingEdited);
		this.subCatNames.add(this.indexOfSubCatIDBeingEdited,
				this.subCatNameBeingEdited);
